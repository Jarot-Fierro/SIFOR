...
urlpatterns = [
    ...
    path('form/<str:code>/validate/', views.validate_form_identity, name="validate_form_identity"),
    path('form/<str:code>/view/', views.view_form_with_token, name="view_form_with_token"),
    ...
    path('form/<str:code>/generate-test-responses', views.generate_test_responses, name="generate_test_responses"),
