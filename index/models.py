...
class Form(models.Model):
    ...
    collect_token = models.BooleanField(default=False, verbose_name="Recopilar Token")
...
class FormToken(models.Model):
    ...
    tokencopy = models.CharField(max_length=64, blank=True, null=True, verbose_name="Copia del Token")
